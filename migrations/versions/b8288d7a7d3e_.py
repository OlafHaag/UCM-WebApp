...
def upgrade():
    ...
    sa.Column('treatment', sa.String(length=120), nullable=True, comment='Which degree of freedom had a constraint on it during a block.'),
    ...
    sa.Column('df1', sa.Float(), nullable=True, comment='Value of degree of freedom 1 at end of trial. Independent Variable.'),
    sa.Column('df2', sa.Float(), nullable=True, comment='Value of degree of freedom 2 at end of trial. Independent Variable.'),
    ...
    sa.Column('sum', sa.Float(), nullable=True, comment='Sum of values for df1 and df2 at end of trial. This is the dependent variable.'),
